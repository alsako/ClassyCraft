...
public class AddMethodState implements ClassyState{
    ...
    public void misKliknut(Point p, DiagramView diagramView) {
        ...
        for (ElementPainter painter:diagramPainters) {
            if(painter instanceof InterclassPainter && painter.elementAt(p.x, p.y) && !(painter instanceof EnumPainter)){
                ...
                nmo.addWindowListener(new WindowAdapter() {
                    ...
                    public void windowClosed(WindowEvent windowEvent) {
                        ...
                        System.out.println(selectedName + selectedType + selectedVisibility);
